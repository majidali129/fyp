  ...
  return (
    <div className="rounded-sm rounded-t-[0.2rem] shadow-lg">
      ...
      <div className="py-2 *:px-2 space-y-2.5">
        ...
        {isOldPrice&& <span className="text-gray-500 line-through text-sm">${800}</span>}
        </div>
...
function InstructorActions ({courseId}: {courseId: string}) {
    ...
    return (
        <DropdownMenu>
  <DropdownMenuTrigger className="focus:outline-none"><BsThreeDots className="text-gray-900 w-4 h-4" /></DropdownMenuTrigger>
