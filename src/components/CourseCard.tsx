...
import { formateNumber, formateNumberInK } from "@/helpers";
import { FaStar } from "react-icons/fa";
import img from "../../public/images/courseImg.png";

const CourseCard = () => {
  return (
    <div className="rounded-sm rounded-t-[0.3rem] shadow">
      <Image
        src={img}
        alt="course cover photo"
        priority
        height={180}
        className="max-sm:h-[220px] rounded-t-[0.3rem] rounded-b-[0.2rem] select-none"
      />
